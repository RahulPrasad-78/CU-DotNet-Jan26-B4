namespace StreamBuzz
{
    ...
    {
        public static List<CreatorStats> EngaBoard = new List<CreatorStats>();

        public void RegisterCreator(CreatorStats record)
        {
            EngaBoard.Add(record);
        }
            ...
            while (true)
            {
                ...
                switch (choice)
                {
                    ...
                    case 2:
                        ...
                        var result = p.GetTopPostCounts(EngaBoard, threshold);
