namespace LINQ
{
    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine();
            Console.WriteLine("===== PRODUCTS & SALES TABLES =====");
            Console.WriteLine();
            ...
            Console.WriteLine();
            Console.WriteLine("===== CUSTOMERS & ORDERS TABLES =====");
            Console.WriteLine();
            ...
            Console.WriteLine();
            Console.WriteLine("===== TRANSACTIONS TABLE =====");
            Console.WriteLine();
            ...
            Console.WriteLine();
            Console.WriteLine("===== USERS & POSTS TABLES =====");
            Console.WriteLine();
