...
namespace FinTrackPro.Controllers
{
    public class TransactionsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Description,Amount,AccountId")] Transaction transaction)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Description,Amount,AccountId")] Transaction transaction)
        {
